        ...
        <div className="container mx-auto">
          ...
          >
            <Input
              ...
              name="user_name"
              className={`bg-white ${!isUserNameValid ? "border-red-500" : ""}`}
              required
            />
            {!isUserNameValid && (
            ...
            <Input
              ...
              placeholder="Email"
              name="user_email"
              className={`bg-white ${!isUserEmailValid ? "border-red-500" : ""}`}
              required
            />
            {!isUserEmailValid && (
              <p className="text-white -mt-3 text-sm">
            ...
            <Textarea
              ...
              name="user_message"
              className={`bg-white ${!isUserMessageValid ? "border-red-500" : ""}`}
              required
            />
            {!isUserMessageValid && (
              <p className="text-white -mt-3 text-sm">
